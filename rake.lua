...
local function currentitems()
    local teleportinfo="teleporting too often might kill you. enable tp cooldown if this happens often"
    if menustate.tab==1 then
        local items={
            section("master",1),{id="bindmenu",kind="bind",bind="menu",inlinebind=true,label="menu toggle",col=1},{id="watermark",kind="toggle",label="watermark state",on=toggle.watermark,col=1},{id="esp",kind="toggle",label="esp toggle",on=toggle.esp,bind="esp",inlinebind=true,col=1},{id="hud",kind="toggle",label="hud toggle",on=toggle.hud,bind="hud",inlinebind=true,col=1},{id="teleportcooldown",kind="toggle",label="tp cooldown",on=toggle.teleportcooldown,col=1},
            section("supply crates",1),{id="supplylabel",kind="toggle",label="crate esp",on=toggle.supplylabel,colorindex=8,col=1},{id="supplyitems",kind="toggle",label="supplies esp",on=toggle.supplyitems,info="shows the inventory of a supply crate in correct order, also shows whether an item has been taken or not",col=1},{id="instacrate",kind="toggle",label="instant crate",on=toggle.instacrate,info="requires hybrid mode, may not work with pre-existing crates",permission="hybrid",col=1},
            section("scraps esp",1),{id="scrap",kind="toggle",label="tp to scrap",on=toggle.scrapteleportenabled,bind="scrap",inlinebind=true,info=teleportinfo,warning=true,unstable=true,col=1},{id="scrapteleportselect",kind="dropdown",label="sort by",value=toggle.scrapteleport,col=1},{id="sell",kind="toggle",label="tp to sell",on=toggle.sellenabled,bind="sell",inlinebind=true,info="requires hybrid-mode, using the bind will teleport you to the shop and sell your scrap",permission="hybrid",col=1},{id="itemScrap1",kind="toggle",label="scrap 1",on=espgroups.items.Scrap1,itemkey="Scrap1",colorindex=2,col=1},{id="itemScrap2",kind="toggle",label="scrap 2",on=espgroups.items.Scrap2,itemkey="Scrap2",colorindex=3,col=1},{id="itemScrap3",kind="toggle",label="scrap 3",on=espgroups.items.Scrap3,itemkey="Scrap3",colorindex=4,col=1},{id="itemScrap4",kind="toggle",label="scrap 4",on=espgroups.items.Scrap4,itemkey="Scrap4",colorindex=5,col=1},{id="itemScrap5",kind="toggle",label="scrap 5",on=espgroups.items.Scrap5,itemkey="Scrap5",colorindex=6,col=1},{id="scrapstyleselect",kind="dropdown",label="scrap style",value=toggle.scrapstyle,col=1},
            section("distance esp",1),{id="distance",kind="toggle",label="distance",on=toggle.distance,colorindex="distance",col=1},{id="distancepositionselect",kind="dropdown",label="label position",value=toggle.distanceposition,col=1},{id="distanceminimum",kind="toggle",label="minimum distance",on=toggle.distanceminimum,col=1},{id="distancemin",kind="slider",label="show distance after",value=toggle.distancemin,min=0,max=100,display=tostring(toggle.distancemin).."m",col=1},
            ...
            section("timer",1),{id="hudtimer",kind="toggle",label="timer hud",on=toggle.hudelements.timer,col=1},{id="timerformatselect",kind="dropdown",label="timer style",value=toggle.timerformat,col=1},{id="timerwarningenabled",kind="toggle",label="timer warning",on=toggle.timerwarningenabled,colorindex="timerwarning",col=1},{id="timerwarning",kind="slider",label="warning time",value=toggle.timerwarning,min=10,max=45,display=tostring(toggle.timerwarning).."s",col=1},
            section("client",2),{id="noJumpCooldown",kind="toggle",label="no jump cooldown",on=toggle.client.noJumpCooldown,info="unstable: may lag during the initial scan, may need to be re-enabled after respawning or state changes, and may still freeze as the game continues",warning=true,unstable=true,col=2},{id="infiniteStamina",kind="toggle",label="infinite stamina",on=toggle.client.infiniteStamina,info="unstable: may lag during the initial scan, may need to be re-enabled after respawning or state changes, and may still freeze as the game continues",warning=true,unstable=true,col=2},{id="noFall",kind="toggle",label="no fall damage",on=toggle.client.noFall,col=2},
            section("combat",2),{id="killaura",kind="toggle",label="stun aura",on=toggle.killaura,bind="aura",inlinebind=true,info="requires hybrid-mode, doesn't use stamina, requires an equipped stun stick",permission="hybrid",col=2},{id="killaurarange",kind="slider",label="aura range",value=toggle.killaurarange,min=6,max=30,display=tostring(toggle.killaurarange).." studs",col=2},{id="killauradelay",kind="slider",label="aura delay",value=toggle.killauradelay,min=0.05,max=0.6,display=string.format("%.2fs",toggle.killauradelay),col=2},
            ...
            section("player hud",2),{id="hudtarget",kind="toggle",label="rake target",on=toggle.hudelements.target,col=2},{id="hudscrap",kind="toggle",label="scrap value",on=toggle.hudelements.scrap,col=2},{id="hudpower",kind="toggle",label="power left",on=toggle.hudelements.power,info="requires unsafe LuaU mode enabled",permission="unsafe",col=2},
            section("objects esp",2),{id="flares",kind="toggle",label="flare gun",on=espgroups.flares,colorindex=1,col=2},{id="flare",kind="toggle",label="tp to flare",on=toggle.flareteleportenabled,bind="flare",inlinebind=true,info=teleportinfo,warning=true,unstable=true,col=2},{id="traps",kind="toggle",label="rake trap",on=espgroups.traps,colorindex=7,col=2},
            ...
            section("location esp",2),{id="roof",kind="toggle",label="roof HP",on=toggle.roof,colorindex="roof",col=2}
        }
...
toggle.sellscraps=function()
    local night=rs:FindFirstChild("Night");if night then local ok,value=pcall(function()return night.Value end);if ok and value==true then return false,"night"end end
    ...
    if not destination then local object=finddesc(ws,"ShopMSG");while object and object~=ws and not object:IsA("BasePart")do object=object.Parent end;if object and object:IsA("BasePart")then destination=object end end;if not destination then return false,"shop"end
    local moved=pcall(function()root.CFrame=destination.CFrame+Vector3.new(0,3,0)end);if not moved then return false,"shop"end
    task.wait(0.2);local event=rs:FindFirstChild("ShopEvent");if not event then return false,"event"end;local fired=pcall(function()event:FireServer("SellScraps","Scraps")end);return fired,fired and nil or"event"
end
...
toggle.setteleportcooldown=function(value,quiet)
    toggle.teleportcooldown=value==true;if not toggle.teleportcooldown then toggle.cooldownuntil=0;toggle.cooldownremaining=0;toggle.teleporthistory={};toggle.cooldowndraw.value.Visible=false;toggle.cooldowndraw.label.Visible=false end;hudpos();showhud();menuupdate();if not quiet then bindlog(toggle.teleportcooldown and"enabled tp cooldown"or"disabled tp cooldown")end
end
...
local function runaction(id)
    ...
    elseif id=="sell"then
        if not toggle.sellenabled then return end;local ok,reason=toggle.sellscraps();bindlog(ok and"teleported to shop and sold scraps"or reason=="night"and"sell scraps is unavailable at night"or"shop or sell event not found")
...
local function clickmenu(mx,my)
    ...
    for i=1,#itemlayouts do
        ...
        if layout.visible and item.kind~="section"and inside(mx,my,layout.x,layout.hittop,layout.w,layout.hitbottom-layout.hittop)then
            ...
            local infolayout=toggle.menuinfo.layouts[i];if infolayout and inside(mx,my,infolayout.x,infolayout.y,infolayout.w,infolayout.h)then return end
