...
local menustate={w=390,h=470,watermarkw=100,watermarkh=27,x=24,y=math.floor((cam.ViewportSize.Y-470)/2),tab=1,minimized=false,maxitems=64,scroll={},scrolltarget={},scrollmax={},itemkinds={},hover={},toggleanim={},slideranim={},tabfade=1,tabslide=0,indicatorx=nil,indicatorw=nil,itemsdirty=true}
...
local inputstate={dragging=false,sliding=nil,scrolling=nil,powerdragging=false,groupdragging=false,mouseheld=false,dragx=0,dragy=0,powerdragx=0,powerdragy=0,groupdragx=0,groupdragy=0,scrolly=0,scrollstart=0,wheel=0}
